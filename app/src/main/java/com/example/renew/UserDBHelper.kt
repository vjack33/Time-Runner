...
class UsersDBHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun getRegulariseMonth(dataMonthOfYear: String): Int {
        val countQuery = "SELECT  * FROM " + DBContract.UserEntry.TABLE_NAME + " WHERE " + DBContract.UserEntry.COLUMN_DATA_MONTH_OF_YEAR + " = " + dataMonthOfYear + " AND " + DBContract.UserEntry.COLUMN_DATA_REG + " = 'Yes'"
    ...
    fun getLeaveMonth(dataMonthOfYear: String): Int {
        val countQuery = "SELECT  * FROM " + DBContract.UserEntry.TABLE_NAME + " WHERE " + DBContract.UserEntry.COLUMN_DATA_MONTH_OF_YEAR + " = " + dataMonthOfYear + " AND " + DBContract.UserEntry.COLUMN_DATA_LEAVE + " = 'Yes'"
        val db = this.readableDatabase
        val cursor = db.rawQuery(countQuery, null)
        val count = cursor.count
        cursor.close()
